...
int tirage_SFR( const float* pos, int NPart, const float* P, const float* L, int NTirage, float rhoMin, float* posOut, unsigned long int seed, float* mass, float* weight );
